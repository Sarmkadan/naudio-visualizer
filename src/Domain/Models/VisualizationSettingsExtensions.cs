...
public static class VisualizationSettingsExtensions
{
	...
	/// <summary>
	/// Gets the background color as a <see cref="Color"/> structure.
	/// </summary>
	/// <param name="settings">The settings containing the background color.</param>
	/// <returns>The background color as a <see cref="Color"/>.</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="settings"/> is <see langword="null"/>.</exception>
